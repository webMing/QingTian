...
//        formatter.dateFormat = [NSString stringWithFormat:@"%@ %@",D_BII_DATE_Format2, @"00:00:00"];
        formatter.dateFormat = D_BII_DATE_Format2;
    }
...
/// HH:mm
+ (NSDate *)dateWithTimeString2:(NSString *)dateString{
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
    formatter.dateFormat = D_BII_TIME_Format2;
    NSDate* date = [formatter dateFromString:dateString];
    return date;
}
...
-(NSString *)dateTimeString3{
    NSDateFormatter *formatter = [[NSDateFormatter alloc] init];
    formatter.dateFormat = [NSString stringWithFormat:@"%@",D_BII_DATE_Format2];
    return [formatter stringFromDate:self];
}
